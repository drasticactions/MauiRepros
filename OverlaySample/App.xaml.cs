...
{
	private TestWindowOverlay? overlay;
	public MainWindow()
	{
		this.Page = new AppShell();
	}
    ...
    protected override void OnHandlerChanged()
    {
		...
		if (overlay == null)
		{
			this.AddOverlay(overlay = new TestWindowOverlay(this));
		}
    }
}
...
public class TestWindowOverlay : WindowOverlay
{
	...
	class TestOverlayElement : IWindowOverlayElement
	{
		...
		public void Draw(ICanvas canvas, RectF dirtyRect)
		{
			...
			// Should be working but it's not drawing, or I'm missing something?????
